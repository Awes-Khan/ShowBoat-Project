                                        ...
                                        <div class="col mb-4">
                                            <label for="avatarInput" style="padding-top:60px; margin-left:-10px;"
                                                ...
                                                <input type="file" class="form-control"
                                                    value="{{ old('profile_image') }}" id="avatarInput"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#previewContainer').html(
                '<img src="/default-avatar.png" class="img-thumbnail" style="width: 100px;border-radius:100px;padding-top:0px;    margin-top: -10px;" alt="Avatar Preview">'
                );
