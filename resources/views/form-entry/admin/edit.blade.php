        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="card" style="margin-top:100px;">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.form-entry.update', $formEntry->id) }}"
                            ...
                            <div class="form-row ">
                                <div class="form-group col">
                                    ...
                                    <input type="text" name="profile_name" id="profile_name" class="form-control"
                                        value="{{ $formEntry->profile_name }}"required>
                                    @error('profile_name')
                                ...
                                <div class="form-group col">
                                    ...
                                    <input type="email" name="email" id="email" class="form-control"
                                        value="{{ $formEntry->email }}"required>
                                    @error('Email')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col row">
                                    <div class="col row">
                                        ...
                                        <div class="col mb-4">
                                            <label for="avatarInput" style="padding-top:60px; margin-left:-10px;"
                                                class="form-label text-primary">Choose Avatar
                                                <input type="file" class="form-control"
                                                    value="{{ $formEntry->profile_image }}" id="avatarInput"
                                                    style="border: 2px;"name="profile_image" accept="image/*">
                                            </label>
                                        </div>
                                        @error('profile_image')
                                            <span class="text-danger">{{ $message }}</span>
                            ...
                            <div class="form-row">
                                <div class="form-group col">
                                    ...
                                    <input type="text" name="pan_card_number" id="pan_card_number"
                                        value="{{ $formEntry->pan_card_number }}" maxlength="10" minlength="10"
                                ...
                                <div class="form-group col">
                                    ...
                                    <input type="text" name="aadhar_card_number" id="aadhar_card_number"
                                        value="{{ $formEntry->aadhar_card_number }}" minlength="12" maxlength="12"
                                        class="form-control" required>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#previewContainer').html(
                '<img src="{{ asset('/storage/' . ($formEntry->profile_image ?? '/default-avatar.png')) }}" class="img-thumbnail" style="width: 100px;height: 100px;border-radius:100px;padding-top:0px;    margin-top: -10px;" alt="Avatar Preview">'
                );
                ...
                if (file) {
                    ...
                    reader.onload = function(e) {
                        $('#previewContainer').html('<img src="' + e.target.result +
                            '" class="img-thumbnail" style="width: 100px;height: 100px;border-radius:500px;padding-top:0px;margin-top: -10px;"alt="Avatar Preview">'
                            );
                    };
