                ...
                render: function(data, type, full, meta) {
                  // alert('profile image');
                    ...
                    if(data) {
                        ...
                        return '<img src="../storage/'+data+'" alt="profile-image" class="avatar" class="img-thumbnail" width="60" height="60" style="border-radius:50px" />';
                    } else {
                        return '';
                    }
                },
            },
            { data: 'profile_name', name: 'profile_name', width: '15%'},

            // { data: 'profile_image', name: 'profile_image' },
            { data: 'email', name: 'email' , width: '15%'},
            { data: 'address', name: 'address' , width: '15%'},
            { data: 'pan_card_number', name: 'pan_card_number', width: '10%' },
            { data: 'aadhar_card_number', name: 'aadhar_card_number', width: '15%' },
